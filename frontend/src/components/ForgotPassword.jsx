...
import { Mail, ArrowRight, CheckCircle, AlertCircle, Sparkles, Key } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-hidden flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="text-center">
          {/* Icon */}
          <motion.div
            className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl flex items-center justify-center shadow-2xl"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
              ...
              <div className="text-left">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-lg rounded-xl border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:border-purple-400/50 transition-all duration-300 disabled:opacity-50"
                  />
                </div>
              </div>
          ...
          >
            ...
            <div className="text-sm text-gray-400">
              ...
              <Link 
                to="/register" 
                className="text-purple-400 hover:text-pink-400 transition-colors duration-300 font-medium"
              >
                Register here
              </Link>
            </div>
        ...
        {/* Glow Effect */}
        <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-orange-500/0 to-red-500/0 group-hover:from-orange-500/20 group-hover:to-red-500/20 blur-xl transition-all duration-700 -z-10"></div>
      </motion.div>
    </div>
  );
};
